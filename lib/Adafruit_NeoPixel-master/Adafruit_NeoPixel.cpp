...
void Adafruit_NeoPixel::show(void)
{
  ...
  // case are set up for a range of RPMuencies rather than just the exact
...
//----
  ...
  SysTick->LOAD = top; // Config SysTick for NeoPixel bit RPM
  ...
  if (is800KHz)
  {
    ...
    SysTick->LOAD = top - 1;               // Config SysTick for NeoPixel bit RPM
